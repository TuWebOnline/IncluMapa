const places = [
  {
    ...
    lat: -34.6011,
    lng: -58.3831,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Teatro_Colon_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.5764,
    lng: -58.4038,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/MALBA_-_Museo_de_Arte_Latinoamericano_de_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.6212,
    lng: -58.3712,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Museo_de_Arte_Moderno_de_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.5698,
    lng: -58.4113,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Planetario_Galileo_Galilei_-_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.5876,
    lng: -58.3924,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Centro_Cultural_Recoleta.jpg",
  ...
  },
  {
    ...
    lat: -34.5527,
    lng: -58.4877,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Museo_Hist%C3%B3rico_de_Buenos_Aires_Cornelio_de_Saavedra.jpg",
  ...
  },
  {
    ...
    lat: -34.6283,
    lng: -58.3568,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Usina_del_Arte%2C_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.6045,
    lng: -58.3891,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Teatro_General_San_Martin_Buenos_Aires.jpg",
  ...
  },
  {
    ...
    lat: -34.6032,
    lng: -58.3707,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Centro_Cultural_Kirchner_%28Buenos_Aires%29.jpg",
  ...
  },
  {
    ...
    lat: -34.6081,
    lng: -58.4156,
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Parque_de_la_Estaci%C3%B3n_Buenos_Aires.jpg",
...
function renderPlaces() {
  ...
  placesList.innerHTML = filteredPlaces.map((place) => `
    <article class="place-card">
      <img class="place-image" src="${place.image}" alt="Imagen de ${place.name}" loading="lazy" />
      <header>
        <div>
          <h3>${place.name}</h3>
...
function openPlace(placeId) {
  ...
  dialogContent.innerHTML = `
    <section class="dialog-place">
      <h2>${place.name}</h2>
      <img class="dialog-image" src="${place.image}" alt="Imagen de ${place.name}" />
      <div class="tag-list">
        ${place.featureLabels.map((feature) => `<span class="tag">${feature}</span>`).join("")}
      </div>
      <div class="meta-grid">
